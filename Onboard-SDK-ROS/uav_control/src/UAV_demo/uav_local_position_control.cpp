...
#include "uav_control/uav_local_position_control.h"
...
{
  ros::init(argc, argv, "uav_local_position_control_node");
  ros::NodeHandle nh;
 ...
 *
 */
int local_position_ctrl(double &xCmd, double &yCmd, double &zCmd)
{
  int ret = 0;
